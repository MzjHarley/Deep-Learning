...
class MyRNN(tf.keras.Model):
    def __init__(self, units):
        ...
        self.state0 = [tf.zeros([128, units]),tf.zeros([128, units])]  # [128,64]
        self.state1 = [tf.zeros([128, units]),tf.zeros([128, units])]  # [128,64]
        ...
        self.rnn_cell2 = tf.keras.layers.LSTMCell(units, dropout=0.5)
